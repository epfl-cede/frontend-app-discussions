      ...
      >
        ...
        <div className="d-flex flex-column post-card-comment px-4 pt-3.5 pb-10px" tabIndex="0">
          ...
          {isEditing ? (
            ...
            <HTMLLoader
              cssClassName="comment-body html-loader text-break mt-14px font-style _text-primary-500"
              componentId="comment"
          ...
          {!isNested && showFullThread && (
            isReplying ? (
              ...
              !isClosed && isUserPrivilegedInPostingRestriction && (inlineReplies.length >= 5) && (
                <Button
                  className="d-flex flex-grow mt-2 font-style font-weight-500 _text-primary-500 add-comment-btn rounded-0"
                  variant="plain"
                  style={{ height: '36px' }}
